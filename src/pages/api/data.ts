    ...
    sections: {
      about: {
        ...
        list: [
          {
            title: 'Perda de peso',
            description: 'Em uma sessão de treino, o aluno pode consumir até 1000kcal.'
          },
          {
            title: 'Definição muscular',
            description: 'Muitos alunos, a longo prazo, relatam aumento de massa muscular, além do emagrecimento.'
          },
          {
            title: 'Hábitos saudáveis',
            description: 'Para performar melhor nos treinos, normalmente, o aluno busca ajustar a quialidade do sono e alimentação.'
          }
        ]    
      },
      schedules: {
      ...
      instagram: {
        buttonInstagramText: 'Siga-nos no Instagram'
      },
      reviews: {
        title1: 'A opinião dos',
        title2: 'nossos alunos',
        list: [
          {
